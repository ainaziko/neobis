...
public class Order {
    ...
    public boolean equals(Object o) {
        ...
        Order order = (Order) o;
        return orderId == order.orderId && dessertDuplicates == order.dessertDuplicates && softDrinkDuplicates == order.softDrinkDuplicates && Objects.equals(dessert, order.dessert) && Objects.equals(softDrink, order.softDrink) && Objects.equals(date, order.date);
    }

    @Override
    public int hashCode() {
        return Objects.hash(orderId, dessert, dessertDuplicates, softDrink, softDrinkDuplicates, date);
    }
}
